...
$page = $_GET['p'];
$page_size = 5;
$sql = "select * from loss_reporting ORDER  by Reader_id LIMIT ".($page-1)*$page_size .",$page_size";
$query  = mysqli_query($con,$sql);
$total_sql = "select * from loss_reporting ORDER  by Reader_id";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="form-horizontal" id="form_add" method="post" action="loss_reporting.add.php">
                        <div class="row">
