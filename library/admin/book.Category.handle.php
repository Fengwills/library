...
$page = $_GET['p'];
$page_size = 5;
$category = $_GET['query_tname'];
$sql = "select * from b_category WHERE category LIKE '%$category%'ORDER  by Category_id LIMIT ".($page-1)*$page_size.",$page_size";
$query = mysqli_query($con,$sql);
$total_sql = "select * from b_category WHERE category LIKE '%$category%'ORDER  by Category_id";
                                    ...
                                    <ul class="pagination">
                                        ...
                                        if($page>1)
                                        {
                                            $page_banner="<li class='paginate_button previous' id='data_list_previous'><a
                                                href=".$_SERVER['PHP_SELF']."?p=".($page-1)."&query_tname=".$category."
                                            >上一页</a></li>";
                                            echo "$page_banner";
                                        }
                                        if($page<$total_page)
                    ...
                    <form class="form-horizontal" id="form_update" method="post" action="category.update.php">
                        <div class="row">
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" id="update_id" type="text" value="">
