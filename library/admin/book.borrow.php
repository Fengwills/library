...
?>
<!DOCTYPE html>
<!-- saved from url=(0048)http://www.xn-%2D8wvw7t.com/library/admin/borrow -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal" method="post" action="book.borrow.handle.php">
                                <div class="row">
                                    <div class="col-lg-5 form-group">
                                        <label class="col-lg-4 control-label" for="borrow_rno"><label class="text-danger">*&nbsp;</label>读者编号</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="borrow_rno" name="borrow_rno" type="text" value="">
                                            <label class="control-label" for="borrow_rno" style="display: none"></label>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 form-group">
                                        <label class="col-lg-4 control-label" for="borrow_bno"><label class="text-danger">*&nbsp;</label>图书编号</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="borrow_bno" name="borrow_bno" type="text" value="">
                                            <label class="control-label" for="borrow_bno" style="display: none"></label>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 form-group">
                                        <input type="submit" class="btn btn-primary" id="btn_borrow" value="借书"/>
                                    </div>
                                </div>
                            </form>
                        </div>
