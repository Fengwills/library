...
$sql = "select * from borrow_info WHERE Reader_id = '$Reader_id'AND Book_id LIKE '%$Book_id%' AND Book_name LIKE '%$Book_name%' ORDER BY Date_borrow DESC  LIMIT ".($page-1)*$page_size .",$page_size";
$query  = mysqli_query($con,$sql);
$total_sql = "select * from borrow_info WHERE Reader_id = '$Reader_id'AND Book_id LIKE '%$Book_id%' AND Book_name LIKE '%$Book_name%' ORDER BY Date_borrow DESC ";
