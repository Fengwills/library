...
$sql = "select * from history WHERE Reader_id = '$Reader_id'ORDER BY Date_borrow DESC LIMIT ".($page-1)*$page_size .",$page_size";
$query  = mysqli_query($con,$sql);
$total_sql = "select * from history WHERE Reader_id = '$Reader_id'ORDER BY Date_borrow DESC ";
