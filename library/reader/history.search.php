...
$Book_id = $_GET['query_bno'];
$Book_name = $_GET['query_bname'];
$sql = "select * from history WHERE Reader_id = '$Reader_id'AND Book_id LIKE '%$Book_id%' AND Book_name LIKE '%$Book_name%' ORDER BY Date_borrow DESC  LIMIT ".($page-1)*$page_size.",$page_size";
$query  = mysqli_query($con,$sql);
$total_sql = "select * from history WHERE Reader_id = '$Reader_id'AND Book_id LIKE '%$Book_id%' AND Book_name LIKE '%$Book_name%' ORDER BY Date_borrow DESC ";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal" method="get" action="history.search.php">
                                <div class="row">
                                    ...
                                    <ul class="pagination">
                                        ...
                                        if($page>1)
                                        {
                                            $page_banner="<li class='paginate_button previous' id='data_list_previous'><a
                                                href=".$_SERVER['PHP_SELF']."?p=".($page-1)."&query_bno=".$Book_id."&query_bname=".$Book_name."
                                            >上一页</a></li>";
                                            echo "$page_banner";
                                        }
                                        if($page<$total_page)
