...
$(function () {
    table = $('#data_list').DataTable({
        "ajax": {
            "url": "/library/admin/bookType/list",
            "type": "POST",
            "data": function (d) {
                return {
...
function add() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/library/admin/bookType/save',
        cache: false,
        data: param,
...
function showUpdate(Category_id,Category) {
            $("#update_id").val(Category_id);
            $("#update_tname").val(Category);
...
function update() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/library/admin/bookType/update',
        cache: false,
        data: param,
        success: function (data) {
            if (data == 1) {
...
function del() {
    jQuery.ajax({
        type: 'POST',
        url: '/library/admin/bookType/delete',
        cache: false,
        data: {
            id: $('#delete_id').val()
        },
