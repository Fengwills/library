...
function showDetail(Book_id,Book_name,author,publishing,Category_id,price,Date_in,Quantity_in,Quantity_out,Quantity_loss) {;
            $("#detail_Book_id").val(Book_id);
            $("#detail_Book_name").val(Book_name);
            $("#detail_author").val(author);
            $("#detail_publishing").val(publishing);
            $("#detail_Category").val(Category_id);
            $("#detail_price").val(price);
            $("#detail_Date_in").val(Date_in);
            $("#detail_Quantity_in").val(Quantity_in);
            $("#detail_Quantity_out").val(Quantity_out);
            $("#detail_Quantity_loss").val(Quantity_loss);
...
function showUpdate(Book_id,Book_name,author,publishing,Category_id,price,Quantity_in,Quantity_out,Quantity_loss) {
    $("#update_Book_id").val(Book_id);
    $("#update_Book_name").val(Book_name);
    $("#update_author").val(author);
    $("#update_publishing").val(publishing);
    $("#update_Category").val(Category_id);
    $("#update_price").val(price);
    $("#update_Quantity_in").val(Quantity_in);
    $("#update_Quantity_out").val(Quantity_out);
    $("#update_Quantity_loss").val(Quantity_loss);
