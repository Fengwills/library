...
$(function () {
    table = $('#data_list').DataTable({
        "ajax": {
            "url": "/library/admin/student/list",
            "type": "POST",
            "data": function (d) {
                return {
                    "sno": $('#query_sno').val(),
...
function add() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/library/admin/student/save',
        cache: false,
        data: param,
...
function showUpdate(id) {
    jQuery.ajax({
        type: 'POST',
        url: '/library/admin/student/findById',
        cache: false,
        data: {id: id},
        success: function (data) {
...
function update() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/library/admin/student/update',
        cache: false,
        data: param,
        success: function (data) {
            if (data) {
...
function del() {
    jQuery.ajax({
        type: 'POST',
        url: '/library/admin/student/delete',
        cache: false,
        data: {
            id: $('#delete_id').val()
        },
